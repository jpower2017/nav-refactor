...
class Nav extends Component {
  ...
  updateChildren = (item, data, bShow) => {
  ...
  setChildrenShowing = (item, data, bShow) => {
    ...
    if (this.hasChildrenShowing(item)) {
      this.setState({
        data: cUpdateChildren(
          cUpdateSibs(cSetChildrenShowing(this.state.data, false), true),
          false
        )
      });
      ...
      this.setState({
        data: cUpdateChildren(
          cUpdateSibs(cSetChildrenShowing(this.state.data, true), false),
          true
        )
      });
    }
